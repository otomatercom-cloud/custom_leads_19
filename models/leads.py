...
class LeadAssignmentHistory(models.Model):
    ...
    lead_id = fields.Many2one('leads.logic', index=True, string='Lead', ondelete='cascade')
...
class LeadFollowUp(models.Model):
    ...
    lead_id = fields.Many2one('leads.logic', index=True, string="Lead", ondelete="cascade", required=True)
...
class LeadUnlockWizard(models.TransientModel):
    ...
    lead_id = fields.Many2one("leads.logic", index=True, required=True)
...
class LeadOpenHistory(models.Model):
    ...
    lead_id = fields.Many2one('leads.logic', index=True, string='Lead', required=True, ondelete='cascade')
